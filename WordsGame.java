...
public void GameCore() {
    ...
    int PresentPlayer = this.firstLetter;
        ...
        while(playing) {
            ...
            System.out.println("----------------------------------");
            String TheWord = this.input.nextLine();
            ...
            if(new LimitedVocabulary().WordInDictionary(TheWord)) {
                ...
                String startOfWord = TheWord.substring(0, FirstLetter.length());
                        if(!startOfWord.equals(FirstLetter)) {
                                System.out.println("----------------------------------");
...
//points sharing by each word
if(player == 1) {  
    if(Vowels > 0)
        {   
            System.out.println("-----------------------------------------------------------------");
            System.out.println(actualplayer + " has achieved " + VowelPoint + " point with the word " + TheWord + "!");
            System.out.println("------------------------------------------------------------------");
        }else{
            System.out.println(actualplayer + " has achieved " + Points + " points with the word " + TheWord + "!");
            System.out.println("-----------------------------------------------------------------");
        }
        }else{
            if(Vowels > 0)
        {   
            System.out.println("-----------------------------------------------------------------");   
            System.out.println(actualplayer + " has scored " + VowelPoint + " point with the word " + TheWord + "!");
            System.out.println("-----------------------------------------------------------------");

        }else{
            System.out.println("-----------------------------------------------------------------");    
            System.out.println(actualplayer + " has scored " + Points + " points with the word " + TheWord + "!");
            System.out.println("-----------------------------------------------------------------");
